...
class documentModel extends document
{
	...
	function getDocument($document_srl=0, $is_admin = false, $load_extra_vars=true, $columnList = array())
	{
		...
		{
			if(isset($GLOBALS['XE_DOCUMENT_LIST'][$document_srl]->columnListKey) && $GLOBALS['XE_DOCUMENT_LIST'][$document_srl]->columnListKey != serialize($columnList) && $GLOBALS['XE_DOCUMENT_LIST'][$document_srl]->columnListKey != serialize(array()))
			{
				$ori_columnList = unserialize($GLOBALS['XE_DOCUMENT_LIST'][$document_srl]->columnListKey);
				$des_columnList = array_merge((array)$ori_columnList, (array)$columnList);
			...
			if(!isset($ori_columnList) || $GLOBALS['XE_DOCUMENT_LIST'][$document_srl]->columnListKey != serialize($des_columnList))
			{
